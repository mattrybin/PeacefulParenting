...
export const Pagination = ({
  ...
  return (
    <div className="justify-self-center py-6">
      <div className="join">
        <button
          className={`join-item btn btn-md btn-square ${!hasPrevPage ? "btn-disabled" : ""}`}
          onClick={onPrevPage}
        >
          <Icons
        ...
        <button
          className={`join-item btn btn-square btn-md ${!hasNextPage ? "btn-disabled" : ""}`}
          onClick={onNextPage}
        >
          <Icons
            variant="arrow-fat-right"
            weight="fill"
            size="5"
          />
        </button>
