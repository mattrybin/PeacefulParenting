    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            <Icons variant="x" weight="bold" className="text-8 swap-on" />
            <Icons
...
const Menu = ({
  ...
  return (
    <ul
      className={clsx(
        "dropdown-content z-50 menu p-2 shadow bg-base-100 rounded-box w-80",
        {
          hidden: !open,
        }
      )}
    ...
    >
      <li className="">
        <Link href="/questions" onClick={closeMenu}>
          <Icons weight={"duotone"} variant={"seal-question"} size="7" />
          <div className="font-semibold">Questions</div>
        </Link>
      </li>
      <li>
        <Link href="/chat" onClick={closeMenu}>
          <Icons weight={"duotone"} variant={"wechat-logo"} size="7" />
          <div className="font-semibold">Chat AI</div>
        </Link>
      </li>
      <li>
        <Link href="/resources" onClick={closeMenu}>
          <Icons weight="duotone" variant="book-bookmark" size="7" />
          <div className="font-semibold">Resources</div>
        </Link>
      </li>
      <li>
        <Link href="/login" onClick={closeMenu}>
          <Icons weight="duotone" variant="user-circle" size="7" />
      ...
      <div className="grid grid-flow-row bg-base-200/50 border rounded-[7px] p-4 text-center gap-2 mt-2">
        <span className="w-full font-semibold text-base-content/80">
          Appearance
        </span>
