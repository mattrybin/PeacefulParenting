...
export default function HomePage() {
  ...
  return (
    <PageContainer>
      ...
      <div>
        <Markdown className="px-6 py-6 prose-lg mx-auto">{markdown}</Markdown>
      </div>
      <div className="">
        <div className="font-semibold flex justify-center border border-base-content border-x-0 p-4 text-lg">
        ...
        <div>
          <div className="flex bg-primary text-primary-content justify-center border-y border-base-300 p-2 gap-2 font-bold items-center ipad:text-lg">
            <i className="ph-bold ph-plus"></i> <div>Add Answer</div>
          </div>
          <div>
            {/* make it stand out a litle!? */}
            <div className="flex justify-center p-2 gap-2 font-bold bg-base-200 text-base-content ipad:text-lg">
              <div>3 Answers</div>
            </div>
