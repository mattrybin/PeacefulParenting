export default function Page() {
  return (
    <div className="p-3">
      ...
      <div className="text-base-300 py-5">
...
const Course = ({
  ...
  <div className="py-5">
    <div className="text-xl font-semibold">
      {CourseTitle}
      <div className="h-44 rounded-lg flex">
        <img className="mx-auto w-full rounded-lg" src={CourseImg}></img>
      </div>
      <div className="text-lg font-normal text-white">{BriefInfo}</div>
      <div className="flex justify-end gap-3 p-2">
        <div className="w-12 h-12">
          <img className="rounded-full" src={AuthorImg}></img>
        </div>
        <div className="text-sm my-auto font-normal text-base-300">
          {Author}
        </div>
      </div>
    </div>
...
const Book = ({ ImgLink, BookTitle, Author, BriefInfo }: any) => (
  <div className="flex gap-3 py-4">
    ...
    <div className="w-[350px] text-2xl">
      {BookTitle}
      <div className="text-xs text-base-300 pt-1">
        {Author}
        <div className="text-white text-sm pt-1">{BriefInfo}</div>
      </div>
    </div>
  </div>
);
