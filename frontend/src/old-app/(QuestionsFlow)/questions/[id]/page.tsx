...
import { Header } from "app/(QuestionsFlow)/components/Header";
import { CommentSection } from "app/(QuestionsFlow)/components/CommentSection";
...
>>>>>>> 3c79315 (feat: redesign single page (#26))
    </PageContainer>
  )
}
